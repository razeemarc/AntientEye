...
class FeedbackMarunthuKottai extends StatefulWidget {
  @override
  _FeedbackMarunthuKottaiState createState() => _FeedbackMarunthuKottaiState();
}

class _FeedbackMarunthuKottaiState extends State<FeedbackMarunthuKottai> {
  ...
  fetchCharacterVoices() async{
    var records =await FirebaseFirestore.instance.collection('MKFeedback').get();
    mapRecords(records);
  }
