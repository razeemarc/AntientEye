...
import 'package:flutter_text_to_speech_tutorial/consts_vk.dart';
import 'package:flutter_tts/flutter_tts.dart';
import 'content_vk.dart';
...
class ImageSliderAppVK extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: VattakottaiFortPage(),
    );
  }
}

class VattakottaiFortPage extends StatefulWidget {
  const VattakottaiFortPage({Key? key});

  @override
  State<VattakottaiFortPage> createState() => _VattakottaiFortPageState();
}

class _VattakottaiFortPageState extends State<VattakottaiFortPage> {
          ...
          Positioned(
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ContentPageVK()),
                ).then((_) {
