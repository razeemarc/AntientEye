...
import 'package:flutter_text_to_speech_tutorial/consts_mk.dart';
import 'package:flutter_tts/flutter_tts.dart';
import 'content_mk.dart';
...
class ImageSliderAppMK extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MarunthukottaiPage(),
    );
  }
}

class MarunthukottaiPage extends StatefulWidget {
  const MarunthukottaiPage({Key? key});

  @override
  State<MarunthukottaiPage> createState() => _MarunthukottaiPageState();
}

class _MarunthukottaiPageState extends State<MarunthukottaiPage> {
          ...
          Positioned(
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ContentPageMK()),
                ).then((_) {
